...
var qualityIds = process.argv[1].split(",").map(function(a){return parseInt(a);});
var randomise = process.argv[2] === "1";
var playlistId = process.argv.length > 3 ? process.argv[3] : null;
